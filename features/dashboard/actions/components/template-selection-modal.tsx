...
import { ChevronRight, Search, Star, Code, Server, Globe, Zap, Clock, Check, Plus, PlusIcon, SearchIcon, StarIcon } from "lucide-react"
                        ...
                        <>
                            <DialogHeader>
                                <DialogTitle className="text-2xl font-bold text-[#e93f3f] flex items-center gap-2">
                                    <PlusIcon size={24} className="text-[#e93f3f]" />
                                    Select a Template
                                </DialogTitle>

                                <DialogDescription>
                                    Choose a template to create a new playground
                                </DialogDescription>
                            </DialogHeader>
                                            ...
                                            filteredTemplates.map((template) => (
                                                <div
                                                    ...
                                                    ${selectedTemplate === template.id
                                                            ? "border-[#E93F3F] bg-[#fff8f8] shadow-[0_0_0_1px_#E93F3F,0_8px_20px_rgba(233,63,63,0.15)]"
                                                ...
                                                >
                                                    ...
                                                    {selectedTemplate === template.id && (
                                                        <div className="absolute top-4 left-4 bg-[#E93F3F] text-white rounded-full p-1">
                                                            <Check size={14} />
                                                        </div>
                                                    )}
                        ...
                        <>
                            ...
                            <div className="flex flex-col gap-6 py-4">
                                <div className="flex flex-col gap-2">
                                    ...
                                    <Input
                                        id="project-name"
                                        placeholder="CipherSchool-project"
                                        value={projectName}
